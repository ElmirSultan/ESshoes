  ...
  return (
    ...
    gap-10 max-container">
        ...
        w-full max-xl:padding-x pt-28">
            <p 
            className="text-xl font-montserrat text-red-600">Our Summer Collection</p>
            ...
            font-bold">
              ...
              <br />
              <span className="text-red-600 inline-block mt-3">ES</span> Shoes
            </h1>
            <p className="font-montserrat text-slate-gray
            text-lg leading-8 mt-6 mb-14 sm:max-w-sm">
              Discover stylish ES arrivals, quality comfort, and innovation for 
              your active life.
            </p>
            ...
            w-full mt-20 gap-16">
              {statistics.map((status) => (
                <div key={status.label}>
                  <p className="text-4xl font-palanquin font-bold">{status.value}</p>
                  <p className="leading-7 font-montserrat text-slate-gray">{status.label}</p>
                </div>
              ))}
            </div>
        </div>
        ...
        max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
          <img src={bigShoeImg} alt="shoe image" width={610} height={500}
